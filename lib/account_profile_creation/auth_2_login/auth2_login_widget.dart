                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '2omi54tc' /* Fill out the information below... */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  context.goNamedAuth(
                                      'chat_2_InviteUsers', context.mounted);
                                },
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'h6e3vonp' /* Don't have an account?   */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
